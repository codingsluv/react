export const Products = [
    {
        id: 1,
        name: 'Ford',
        description: 'Mobil ford adalah mobil yang sangat bagus',
        imageURL:
      ...
      },
      {
        id: 2,
        name: 'Mustang',
        description: 'Mobil Mustang mempunyai desain yang elegan',
        imageURL:
      ...
      },
      {
        id: 3,
        name: 'Toyota',
        description: 'Mobil toyota memiliki interior dan body yang kokoh',
        imageURL:
      ...
      },
      {
        id: 4,
        name: 'Lamborghini',
        description: 'Mobil Lamborghini memiliki interior dan body yang kokoh',
        imageURL:
